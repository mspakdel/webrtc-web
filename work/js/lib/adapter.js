            ...
            shimPeerConnection: function () {
              ...
              window.RTCPeerConnection = function (config) {
                ...
                if (config && config.iceServers) {
                  ...
                  this.iceOptions.iceServers = config.iceServers.filter(
                    function (server) {
              ...
              window.RTCPeerConnection.prototype.setRemoteDescription =
                function (description) {
                  ...
                  sections.forEach(function (mediaSection, sdpMLineIndex) {
                    ...
                    var isComplete =
                      SDPUtils.matchPrefix(mediaSection, "a=end-of-candidates")
                        .length > 0;
                    ...
                    if (description.type === "offer" && !rejected) {
                      var transports = self._createIceAndDtlsTransports(
                        mid,
                        sdpMLineIndex
                      );
                      if (isComplete) {
                      ...
                      if (
                        ...
                        var localtrack =
                          self.localStreams[0].getTracks()[sdpMLineIndex];
